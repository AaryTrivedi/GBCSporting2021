...
namespace GBCSporting2021.Migrations
{
    ...
    [Migration("20210409020415_ConfigurationSeparated")]
    partial class ConfigurationSeparated
    {
            ...
            modelBuilder.Entity("GBCSporting2021.Models.Incident", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            IncidentId = 1,
                            CustomerId = 1,
                            DateOpened = new DateTime(2021, 4, 8, 22, 4, 14, 766, DateTimeKind.Local).AddTicks(4503),
                        ...
                        new
                        {
                            IncidentId = 2,
                            CustomerId = 2,
                            DateOpened = new DateTime(2021, 4, 8, 22, 4, 14, 769, DateTimeKind.Local).AddTicks(804),
            ...
            modelBuilder.Entity("GBCSporting2021.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ReleaseDate = new DateTime(2021, 4, 8, 22, 4, 14, 769, DateTimeKind.Local).AddTicks(5867)
                        },
                        new
                        {
                            ProductId = 2,
                            ...
                            Price = 4.9900000000000002,
                            ReleaseDate = new DateTime(2021, 4, 8, 22, 4, 14, 769, DateTimeKind.Local).AddTicks(6307)
                        },
                        new
                        {
                            ProductId = 3,
                            ...
                            ReleaseDate = new DateTime(2021, 4, 8, 22, 4, 14, 769, DateTimeKind.Local).AddTicks(6327)
                        },
                        new
                        {
                            ProductId = 4,
                            ...
                            Price = 4.9900000000000002,
                            ReleaseDate = new DateTime(2021, 4, 8, 22, 4, 14, 769, DateTimeKind.Local).AddTicks(6331)
                        });
                });
